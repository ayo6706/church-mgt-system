                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="blog.php?epr=leaders">blog-post</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="event.php?epr=leaders">event-post</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                                    <a href="compose.html"><i class="fa fa-user nav_icon"></i>
                                    	manage admin<span class="fa arrow"></span></a>
		                            <ul class="nav nav-second-level">
		                                <li>
		                                    <a href="hod.php?epr=leaders">add hod</a>
		                                </li>
		                                <li>
		                                    <a href="publicity.php?epr=leaders">manage publicity workers</a>
		                                    
		                                </li>
		                            </ul>
                                </li>
                        <li>
                            <a href="guest.php?epr=leaders"><i class="fa fa-user nav_icon"></i>guest user</a>
