...
if($epr=='save')
	{
		...
		if(mysqli_query($conn, $a_sql))
			header("location: blog.php?epr='hod'");
		else
			...
			<div class="form-grids row widget-shadow" 
				...
				<div class="form-body">
					...
					<div class="form-group"> 
							...
							<input type="text" class="form-control form-upload"  value="<?php echo $st_row['id']?>" name="id" placeholder="Enter title"> 
						</div>
					<div class="form-group"> 
							<label for="title">
								Enter title
						...
						<div class="form-group"> 
							<label for="link">link</label>
							 <input type="text" value="<?php echo $st_row['link']?>" name="link" class="form-control form-upload" placeholder="link"> 
						</div> 
						<div class="form-group"> 
			...
			<div class="form-grids row widget-shadow" 
				...
				<div class="form-body">
					<form method="post" enctype="multipart/form-data" action='blog.php?epr=save'> 
						...
						<div class="form-group"> 
							<label for="link">link</label>
							 <input type="text" name="link" class="form-control form-upload" placeholder="link"> 
						</div> 
						<div class="form-group"> 
							<label for="exampleInputFile">File input</label> 
